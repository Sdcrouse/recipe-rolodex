...
**Idea for future self:** In the #redirect_if_nonexistent and #redirect_if_unauthorized_user_tries_to, I should check the types of objects sent to them. If it's "user", use the @user instance variable; if it's "recipe", use @recipe. 
